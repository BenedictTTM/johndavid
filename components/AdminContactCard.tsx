        ...
        >
            ...
            >
                ...
                <div className="rounded-2xl border border-[#713600]/12 bg-[#FAF7C8]/70 backdrop-blur-sm overflow-hidden shadow-[0_2px_12px_rgba(56,36,13,0.06)]">
                    ...
                    <div className="px-4 pt-4 pb-3">
                        <div className="flex items-center justify-between mb-1.5">
                            <span className="text-[9px] font-mono font-bold uppercase tracking-[0.35em] text-[#713600]/50 select-none">
                                Direct Dispatch
                            </span>
                            <span className="flex items-center gap-1.5">
                                <span className="w-1.5 h-1.5 rounded-full bg-[#FF6719] animate-pulse" />
                                <span className="text-[9px] font-mono uppercase text-[#713600]/50 font-bold tracking-wider">
                                    Open
                                </span>
                            </span>
                        </div>
                        <h3 className="text-sm font-serif font-bold text-[#38240D] tracking-tight">
                            Note to Author
                        </h3>
                        <p className="text-[11px] text-[#38240D]/65 leading-relaxed mt-1 font-serif italic">
                            Questions, discussions, or research inquiries sent straight to John David.
                        </p>
                    </div>

                    {/* Divider */}
                    <div className="mx-4 h-px bg-[#713600]/10" />

                    {/* Content */}
                    <div className="p-4">
                        {status === "success" ? (
                            <div className="py-4 text-center flex flex-col items-center">
                                <div className="w-9 h-9 rounded-full bg-[#713600]/10 text-[#713600] flex items-center justify-center mb-2.5">
                                    <Check className="w-4 h-4 stroke-[2.5]" />
                                </div>
                                <p className="text-xs font-serif font-bold text-[#38240D] mb-1">
                                    Note Dispatched
                                </p>
                                <p className="text-[11px] text-[#38240D]/65 leading-normal mb-3">
                                    Thank you. John typically replies within 24–48 hours.
                                </p>
                                <button
                                    type="button"
                                    onClick={() => setStatus("idle")}
                                    className="text-[11px] font-mono font-semibold uppercase tracking-wider text-[#713600] hover:text-[#C05800] transition-colors cursor-pointer"
                                >
                                    + Send another note
                                </button>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                                ...
                                <div>
                                    <label
                                        ...
                                        className="text-[9px] font-mono font-bold uppercase tracking-[0.25em] text-[#713600]/60 mb-1.5 block select-none"
                                    >
                                    ...
                                    <input
                                        ...
                                        className="w-full px-3 py-1.5 text-xs bg-white/70 border border-[#713600]/15 rounded-lg text-[#38240D] placeholder-[#38240D]/40 focus:outline-none focus:ring-1 focus:ring-[#713600] focus:border-[#713600] transition-colors"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full px-3 py-2 text-xs bg-white/70 border border-[#713600]/15 rounded-lg text-[#38240D] placeholder-[#38240D]/40 focus:outline-none focus:ring-1 focus:ring-[#713600] focus:border-[#713600] transition-colors resize-none leading-relaxed"
                                    />
                                </div>
                                ...
                                <div className="flex items-center justify-between pt-1">
                                    <span className="text-[9px] text-[#38240D]/45 font-mono select-none">
                                        ⌘+Enter
                                    </span>
                                    <button
                                        type="submit"
                                        ...
                                        className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all duration-200 cursor-pointer ${
                                            message.trim() && status !== "submitting"
                                                ? "bg-[#713600] text-[#FDFBD4] hover:bg-[#582a00] shadow-xs active:scale-95"
                                                : "bg-[#713600]/10 text-[#713600]/35 cursor-not-allowed"
                                        }`}
                                    >
                                        {status === "submitting" ? (
                                            <span>Sending...</span>
                ...
                <div className="rounded-2xl border border-[#713600]/12 bg-[#FAF7C8]/50 backdrop-blur-sm p-4 shadow-[0_2px_12px_rgba(56,36,13,0.05)]">
                    ...
                    <div className="flex flex-col gap-2.5 text-xs text-[#38240D]/75">
                        <div className="flex items-center justify-between">
                            <span className="flex items-center gap-1.5 text-[#38240D]/60 text-[11px]">
                                <Mail className="w-3 h-3 text-[#713600]/60" />
                                Email
                            </span>
                            <a
                                href="mailto:johndavid@yorku.ca"
                                className="font-mono text-[11px] font-semibold text-[#713600] hover:text-[#C05800] transition-colors"
                            >
                                johndavid@yorku.ca
                            </a>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            <span className="flex items-center gap-1.5 text-[#38240D]/60 text-[11px]">
                                <Clock className="w-3 h-3 text-[#713600]/60" />
                                Cadence
                            </span>
                            <span className="font-mono text-[11px] font-semibold text-[#713600]">
                                24–48 Hours
                            </span>
                        </div>
                    </div>
